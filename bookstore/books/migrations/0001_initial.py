    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_id', models.SmallIntegerField(choices=[(1, 'Python'), (2, 'Javascript'), (3, '数据结构与算法'), (4, '机器学习'), (5, '操作系统'), (6, '数据库')], default='PYTHON', verbose_name='商品种类')),
                ...
                ('details', tinymce.models.HTMLField(verbose_name='商品详情')),
